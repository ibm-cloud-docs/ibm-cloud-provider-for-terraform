...
If you run into an issue with the Terraform on {{site.data.keyword.cloud_notm}} provider plug-in or want to ask questions about how to configure {{site.data.keyword.cloud_notm}} resources, choose one of the following support channels:  
