...
|Data source|Data sources are Terraform objects that you can use to retrieve informatino about {{site.data.keyword.cloud_notm}} resources that you previously provisioned with Terraform on {{site.data.keyword.cloud_notm}}. |
