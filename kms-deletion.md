...
You can refer to [Terraform IBM Modules](https://registry.terraform.io/namespaces/terraform-ibm-modules){: external} to see usage examples. For example, see [terraform-ibm-kms-key](https://registry.terraform.io/modules/terraform-ibm-modules/kms-key/ibm/latest){: external} and [terraform-ibm-kms-all-inclusive](https://registry.terraform.io/modules/terraform-ibm-modules/kms-all-inclusive/ibm/latest){: external}.
...
* [Key Protect keys deletion](/docs/key-protect?topic=key-protect-delete-keys&interface=api#delete-keys-force-delete)
